...
$configList = [
    ...
    new PhpFileProvider('config/backendbase/public-web/{{,*.}global,{,*.}local}.php'),

    new PhpFileProvider('config/autoload/{{,*.}global,{,*.}local}.php'),
    new PhpFileProvider('config/autoload/public-web/{{,*.}global,{,*.}local}.php'),
    // Load development config if it exists
    new PhpFileProvider('config/development.config.php'),
];

$appConfigList = require 'config/autoload/backendbase-application-configs.global.php';
$configList[] = $appConfigList['applicationPublicWebConfigs'];
