...
use BackendBase\Shared\Middleware\CatchUploadedFile;
use BackendBase\Shared\Middleware\CommandLogger;
use BackendBase\Shared\Middleware\ContentNegotiation\ApiContentNegotiationMiddleware;
...
return static function (Application $app, MiddlewareFactory $factory, ContainerInterface $container) : void {
  ...
  //  $app->pipe(ErrorHandler::class);
    ...
    $app->pipe(CatchUploadedFile::class);
    $app->pipe(ServerUrlMiddleware::class);
    $app->pipe(ContentLengthMiddleware::class);
    $app->pipe(CommandLogger::class);
    $app->pipe(ProblemDetailsMiddleware::class);
    $app->pipe(PrivateApiAuthorizationMiddleware::class);
